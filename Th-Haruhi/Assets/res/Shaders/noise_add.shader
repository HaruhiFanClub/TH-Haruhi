...
////// Emissive:
                ...
                float2 node_6354 = (node_6408+float2((_masku*node_6893.g),(node_6893.g*_maskv)));
                ...
                float3 emissive = ((2.0*i.vertexColor.rgb*_TintColor.rgb)*(_MaskTex_var.r*_MaskTex_var.a*_TintColor.a*i.vertexColor.a*lerp( 1.0, step(_DissolveTex_var.r,i.uv1.r), _dissolve_on ))*_alpha_var.rgb*_alpha_var.a);
