...
////// Emissive:
                ...
                float2 node_6354 = ((i.uv0+((i.uv0+(-0.5))*_qiangdu*2.0*_MainTex_var.r*_tex2_var.r))+float2((_masku*node_6893.g),(node_6893.g*_maskv)));
                float4 _MaskTex_var = tex2D(_MaskTex,TRANSFORM_TEX(node_6354, _MaskTex));
                float4 _alpha_var = tex2D(_alpha,TRANSFORM_TEX(i.uv0, _alpha));
                float3 emissive = ((2.0*i.vertexColor.rgb*_TintColor.rgb)*_MaskTex_var.r*_alpha_var.rgb);
                float3 finalColor = emissive;
                float4 _DissolveTex_var = tex2D(_DissolveTex,TRANSFORM_TEX(i.uv0, _DissolveTex));
                return fixed4(finalColor,(i.vertexColor.a*_alpha_var.a*_MaskTex_var.a*lerp( 1.0, step(_DissolveTex_var.r,i.uv1.r), _dissolve_on )));
            }
            ENDCG
        }
    }
