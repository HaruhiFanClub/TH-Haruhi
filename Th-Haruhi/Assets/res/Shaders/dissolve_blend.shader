...
////// Emissive:
                ...
                return fixed4(finalColor,(_MainTex_var.a*i.vertexColor.a*_TintColor.a*lerp( 1.0, step(_DissolveTex_var.r,i.uv1.r), _dissolve_on )*(_MaskTex_var.r*_MaskTex_var.a)));
            }
            ENDCG
        }
    }
