...
public class BossCard1 : BossCardBase
{
    ...
    public override void OnFixedUpdate()
    {
        ...
        if (_shootIdx >= SwitchFrame && _shootIdx % SwitchFrame == 0)
        {
    ...
    {
        if (_shootIdx % BurstHurgeInterval == 0)
        {
    ...
    {
        if(_shootIdx >= HugeFrame && _shootIdx % HugeFrame == 0)
        {
    ...
    private void FireBlueBullet()
    {
        ...
        if (_shootIdx % BlueBulletFrame == 0)
        {
